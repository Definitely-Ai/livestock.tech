...
export const NavbarSection = () => {
  ...
  return (
    <header className="flex h-[72px] items-center justify-center px-[var(--spacing-sizing-page-padding-padding-global)] py-0 bg-[color:var(--color-schemes-color-scheme-1-background)] w-full">
      <div className="flex items-center justify-center gap-8 w-full">
        <div className="flex-1">
          ...
          >
            <img
              ...
              alt="Company logo"
              src="https://c.animaapp.com/LEM5cvaF/img/company-logo-12.svg"
            />
          </a>
        </div>
        ...
        <div className="flex items-center justify-end flex-1">
          <Button
            asChild
            className="px-5 py-2 rounded-xl bg-[color:var(--primitives-color-fern-frond)] text-[#faf6eb] shadow-[0px_1px_2px_#0000000d,inset_0px_-2px_1px_#00000033,inset_0px_0px_0px_1px_#00000026,inset_0px_2px_1px_#ffffff40,inset_0px_32px_24px_#ffffff0d] h-auto"
          >
