        ...
        <div className="flex-1">
          ...
          >
            <img
              ...
              alt="Company logo"
              src="https://c.animaapp.com/LEM5cvaF/img/company-logo-10.svg"
            />
          </a>
        </div>
          ...
          <NavigationMenuList className="flex gap-8">
            {navigationLinks.map((link, index) => (
              <NavigationMenuItem key={index}>
                <Link
                  className="font-[number:var(--text-regular-normal-font-weight)] text-[length:var(--text-regular-normal-font-size)] leading-[var(--text-regular-normal-line-height)] font-text-regular-normal text-[color:var(--color-schemes-color-scheme-1-text)] tracking-[var(--text-regular-normal-letter-spacing)] whitespace-nowrap [font-style:var(--text-regular-normal-font-style)]"
                  to={link.path}
                >
                  {link.text}
                </Link>
