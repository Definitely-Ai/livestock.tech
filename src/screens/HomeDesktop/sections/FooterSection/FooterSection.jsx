...
export const FooterSection = () => {
  ...
  const socialLinks = [
    {
      name: "Facebook",
      icon: "https://c.animaapp.com/LEM5cvaF/img/icon---facebook.svg",
      alt: "Icon facebook",
    },
    {
      name: "Instagram",
      icon: "https://c.animaapp.com/LEM5cvaF/img/icon---instagram.svg",
      alt: "Icon instagram",
    },
    {
      name: "X",
      icon: "https://c.animaapp.com/LEM5cvaF/img/icon---x.svg",
      alt: "Icon x",
    },
    {
      name: "LinkedIn",
      icon: "https://c.animaapp.com/LEM5cvaF/img/icon---linkedin.svg",
      alt: "Icon linkedin",
    },
    {
      name: "YouTube",
      icon: "https://c.animaapp.com/LEM5cvaF/img/icon---youtube.svg",
      alt: "Icon youtube",
    },
  ];
        ...
        <div className="flex items-center gap-8 w-full">
          ...
          <div className="flex-1">
            <img
              ...
              alt="Company logo"
              src="https://c.animaapp.com/LEM5cvaF/img/company-logo-1.svg"
            />
          </div>
