        ...
        <div className="flex-1">
          ...
          >
            <img
              ...
              alt="Company logo"
              src="https://c.animaapp.com/LEM5cvaF/img/company-logo-4.svg"
            />
          </a>
        </div>
            ...
            {navigationLinks.map((link, index) => (
              <NavigationMenuItem key={index}>
                <NavigationMenuLink asChild>
                  <Link
                    className="font-text-regular-normal text-[length:var(--text-regular-normal-font-size)] leading-[var(--text-regular-normal-line-height)] tracking-[var(--text-regular-normal-letter-spacing)] text-[color:var(--color-schemes-color-scheme-1-text)] whitespace-nowrap [font-style:var(--text-regular-normal-font-style)]"
                    to={link.path}
                  >
                    {link.text}
                  </Link>
